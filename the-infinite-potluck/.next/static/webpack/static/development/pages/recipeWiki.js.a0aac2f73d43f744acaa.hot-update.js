              ...
              card.addEventListener("click", function (event) {
                fetch('api/recipeFocus').then(function (response) {
                  response.json().then(function (data) {
                    ...
                    focus.innerHTML = "\n                                            <div style=\"display:flex;flex-direction:column;> \n                                                <div>".concat(focus.title, "</div>\n                                                <img src=").concat(focus.image, "/>\n                                                <div>").concat(focus.summary, "</div>\n                                            </div>\n                                        ");
                  });
                });
              });
            });
...
//# sourceMappingURL=recipeWiki.js.a0aac2f73d43f744acaa.hot-update.js.map