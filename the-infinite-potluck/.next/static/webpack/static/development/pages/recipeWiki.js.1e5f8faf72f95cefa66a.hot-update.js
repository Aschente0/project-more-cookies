                ...
                fetch('api/recipeFocus').then(function (response) {
                  response.json().then(function (data) {
                    ...
                    data.extendedIngredients.forEach(function (ingredient) {
                      ingredients.innerHTML = ingredients.innerHTML + "\n                                                <li>".concat(ingredient.amount, " ").concat(ingredient.unit, "s of ").concat(ingredient.name, "</li>\n                                            ");
                    });
                  });
                });
              });
...
//# sourceMappingURL=recipeWiki.js.1e5f8faf72f95cefa66a.hot-update.js.map