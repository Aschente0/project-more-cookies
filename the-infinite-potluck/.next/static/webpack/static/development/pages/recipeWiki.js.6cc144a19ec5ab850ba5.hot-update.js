                ...
                fetch('api/recipeFocus').then(function (response) {
                  response.json().then(function (data) {
                    ...
                    data.extendedIngredients.forEach(function (ingredient) {
                      var amount = ingredient.amount.toString().substring(0, 2);
...
//# sourceMappingURL=recipeWiki.js.6cc144a19ec5ab850ba5.hot-update.js.map